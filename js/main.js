...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        general_help: "Here is the list of commands that you can use. You can use autofill by pressing the TAB key.",
        ls_help: "List information about file(s)",
        cat_help: "Concatenate and print (display) the content of files",
        whoami_help: "Print the current user id and name ('id -un')",
        date_help: "Display or change the date & time",
        help_help: "Display help for a built-in command",
        clear_help: "Clear terminal screen",
        reboot_help: "Reboot the system",
        cd_help: "Change directory",
        mv_help: "Move or rename files or directories",
        rm_help: "Remove files",
        rmdir_help: "Remove folder(s)",
